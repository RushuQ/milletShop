      ...
      <div class="navbar">
        ...
        <div class="navbar-right-container">
          <div class="navbar-menu-container">
            ...
            <a href="javascript:void(0)" class="navbar-link" v-else @click="logout">登出</a>
            <div class="navbar-cart-container">
              <span class="navbar-cart-count" v-text="cartCount" v-if="cartCount && nickName"></span>
            ...
            <div class="confirm-tips">
              ...
              <ul>
                <li class="regi_form_input">
                  ...
                  <input type="text" tabindex="1" name="6" class="regi_login_input regi_login_input_left"
                         placeholder="用户名" data-type="loginname" v-model="userName">
                </li>
                <li class="regi_form_input noMargin">
                  ...
                  <input type="password" tabindex="2" name="password"
                         ...
                         @keyup.enter="login" v-model="userPwd">
                </li>
              </ul>
            </div>
