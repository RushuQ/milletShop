...
<template>
  <div>
    ...
    <nav-breader muneName="购物车"><span>购物车</span></nav-breader>
              ...
              <li v-for="item in cartList">
                <div class="cart-tab-1">
                  ...
                  <div class="cart-item-pic">
                    <img :src="'/static/'+item.productImage" v-bind:alt="item.productName">
                  </div>
    ...
    <model :mdShow="modalConfirm" @close="closeModal">
